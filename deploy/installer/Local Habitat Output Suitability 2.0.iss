...
#define ExtensionName "Local Habitat Output"
...
AppId={{A39F3AE0-ABA2-48DF-8FC8-A508C54A04B4}
...
Source: {#BuildDir}\Landis.Extension.Output.LocalHabitat-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Local Habitat Output.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Local Habitat Output"" "; WorkingDir: {#LandisPlugInDir}
